            ...
            <Accordion className='p-0' variant='splitted' isCompact>
              {grantList.map((grant, index) => (
                <AccordionItem
                  ...
                  startContent={
                    <Button isIconOnly color='danger' variant='light' onClick={() => onDeleteGrantItem(index)}>
                      <Trash2Icon size={20} />
                    </Button>
                  }
                >
                  <div key={grant.resource || index} className='flex gap-2 pb-4'>
                    <div className='flex-1 gap-2'>
                      <CheckboxGroup
                        ...
                        value={grant.actions}
                        onValueChange={(v) => onActionsSelectionChange(index, Array.from(v) as ERolePermissions[])}
                      >
